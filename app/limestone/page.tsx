...
export default function EPHyperfollowPage() {
    ...
    const handleShare = () => {
        track("Hyperfollow Share", { release: "Limestone EP", page: "/limestone" });
    ...
    const streamingPlatforms = [
        ...
        },
        {
            ...
            icon: <Radio className="w-6 h-6 text-[#C6002B]" />,
        },
        {
            name: "YouTube Music",
            action: "Watch",
        ...
        <main className="relative min-h-screen bg-black text-white overflow-hidden flex flex-col justify-between">
            ...
            <div className="absolute inset-0 z-0">
                <Image
                    ...
                    priority
                />
                <div className="absolute inset-0 bg-gradient-to-b from-black/80 via-black/75 to-black z-0" />
            </div>
            ...
            <section className="relative z-10 container mx-auto px-4 py-8 flex flex-col items-center max-w-md">
                ...
                <div className="flex items-center gap-6 pt-4 border-t border-white/10 w-full justify-center">
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        onClick={() => track("Social Link Click", { platform: "Instagram", page: "/limestone" })}
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        onClick={() => track("Social Link Click", { platform: "TikTok", page: "/limestone" })}
                        className="text-zinc-400 hover:text-white transition-colors transform hover:scale-110"
                        aria-label="TikTok"
                    >
                        <svg
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        onClick={() => track("Social Link Click", { platform: "YouTube", page: "/limestone" })}
                        className="text-zinc-400 hover:text-white transition-colors transform hover:scale-110"
                        aria-label="YouTube"
                    >
                        <Youtube size={22} />
