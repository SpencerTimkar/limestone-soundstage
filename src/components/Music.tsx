    ...
    <section id="music" className="py-24 bg-background">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16 animate-fade-in">
          <h2 className="text-4xl md:text-5xl font-light tracking-wider mb-12 text-foreground">
            Music
          </h2>
        </div>
        ...
        <div className="text-center mt-20 animate-fade-in">
          <div className="bg-accent/10 rounded-lg p-12 max-w-3xl mx-auto">
            <h3 className="text-3xl font-light mb-6 tracking-wide">Merch</h3>
