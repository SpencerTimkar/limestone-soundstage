...
export default function StarvingSection() {
    return (
        <section id="starving" className="relative min-h-[100dvh] md:min-h-[150vh] flex flex-col items-center justify-center py-20 md:py-48 px-6 overflow-hidden ">
            {/* Background Image */}
